...
#         self.relu5_3 = nn.ReLU(inplace=True)                       # 4 layers
#
#
...
class MptNet(nn.Module):
    ...
    def forward(self, x):
        ...
        h_nopool1 = h
        h = self.pool1(h)
        m1 = h_nopool1  # (256x256)*64

        h = self.relu2_1(self.bn2_1(self.conv2_1(h)))
        h = self.relu2_2(self.bn2_2(self.conv2_2(h)))
        h_nopool2 = h
        h = self.pool2(h)
        m2 = h_nopool2  # (128x128)*128
...
if __name__ == "__main__":
    ...
    summary(model_rgb, input_size=(3, 256, 256), batch_size = 1)
